...
var AppComponent = /** @class */ (function () {
    function AppComponent(articleService, mediaQueryHelper, changeDetectorRef, countryService, store, paginationService) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.countryService
            ...
            .subscribe(function (country) { return _this.store.changeCountry$.next(country); });
    ...
    AppComponent.prototype.changeCategory = function (category) {
...
var ArticleListComponent = /** @class */ (function () {
    function ArticleListComponent(dialogService) {
        this.dialogService = dialogService;
    }
    ArticleListComponent.prototype.openArticle = function (url) {
        this.dialogService.openDialog({ url: url });
    };
...
var ArticleComponent = /** @class */ (function () {
    function ArticleComponent(dialogRef, data, sanitizer) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.sanitizer = sanitizer;
    }
    ArticleComponent.prototype.redirect = function () {
...
var CountryPickerComponent = /** @class */ (function () {
    function CountryPickerComponent(ls, store) {
        this.ls = ls;
        this.store = store;
    ...
    CountryPickerComponent.prototype.ngOnInit = function () {
        this.currentCountry$ = this.store.changeCountry$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (countryShort) { return !!countryShort; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (countryShort) { return _models_countries__WEBPACK_IMPORTED_MODULE_2__["Countries"][countryShort].name; }));
    };
    CountryPickerComponent.prototype.selectCountry = function (country) {
        var isoCountry = (function () {
            for (var key in _models_countries__WEBPACK_IMPORTED_MODULE_2__["Countries"]) {
...
var ArticleService = /** @class */ (function () {
    function ArticleService(http, store, searchService, paginationService) {
        this.http = http;
        this.store = store;
    ...
    ArticleService.prototype.getTopHeadlines = function (params) {
        if (params === void 0) { params = {}; }
        return this.http.get("" + this.TOP_HEADLINES, {
            params: Object.assign({ apiKey: this.newsApiKey }, params)
        });
    };
    ArticleService.prototype.getEverything = function (params) {
        if (params === void 0) { params = {}; }
        return this.http.get("" + this.EVERYTHING, {
            params: Object.assign({ apiKey: this.newsApiKey }, params)
        });
    };
    ArticleService.prototype.getArticlesByCountry = function () {
        var _this = this;
        return this.store.changeCountry$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (country) {
            return _this.getTopHeadlines({ country: country, pageSize: pageSize }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
                _this.paginationService.length = data.totalResults;
                return data.articles;
            }));
        }));
    };
    ArticleService.prototype.getArticlesByCategory = function () {
        var _this = this;
        return this.store.changeCategory$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (category) {
            return _this.getTopHeadlines({ country: _this.store.changeCountry$.value, category: category, pageSize: pageSize }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return data.articles; }));
        }));
    };
    ArticleService.prototype.getArticlesBySearch = function (inputRef) {
        var _this = this;
        return this.searchService.getInputValue(inputRef).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (value) {
            return _this.getEverything({ q: value, pageSize: pageSize }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
                _this.paginationService.length = data.totalResults;
                return data.articles;
            }));
        }));
    };
    ArticleService.prototype.getArticlesWhenInputIsEmpty = function () {
        var _this = this;
        return this.store.handleEmptySearch$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (isInputClear) { return isInputClear; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["skip"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () {
            return _this.getTopHeadlines({ country: _this.store.changeCountry$.value }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return data.articles; }));
        }));
    };
    ArticleService.prototype.getArticlesByPage = function (inputRef) {
        var _this = this;
        return this.store.changePage$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (event) {
            return _this.getEverything({
                page: event.pageIndex + 1,
                pageSize: event.pageSize,
                q: inputRef.nativeElement.value
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) { return data.articles; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null); }));
        }));
    };
...
var CountryService = /** @class */ (function () {
    function CountryService(http, ls) {
        this.http = http;
        this.ls = ls;
        this.BASE_URL = 'https://ipapi.co/json';
    }
    CountryService.prototype.getLocalization = function () {
        return this.http.get("" + this.BASE_URL);
    };
    CountryService.prototype.getCountry = function () {
        var _this = this;
        var country = this.ls.get('country');
        if (!country) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])('US'); // 'US' by default for first login
        }
        else {
            return this.getLocalization().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (localization) {
                _this.ls.set('country', localization.country);
...
var DialogService = /** @class */ (function () {
    ...
    DialogService.prototype.openDialog = function (data) {
        var dialogRef = this.dialog.open(_article_article_component__WEBPACK_IMPORTED_MODULE_3__["ArticleComponent"], {
...
var PaginationService = /** @class */ (function () {
    ...
    Object.defineProperty(PaginationService.prototype, "length", {
        get: function () {
            return this._length;
        },
    ...
    Object.defineProperty(PaginationService.prototype, "pageSizeOptions", {
        get: function () {
...
var SearchService = /** @class */ (function () {
    function SearchService(storeService) {
        this.storeService = storeService;
    }
    SearchService.prototype.getInputValue = function (inputRef) {
        var _this = this;
        var fromClick$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(inputRef.nativeElement, 'click');
        var fromKeyUp$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["fromEvent"])(inputRef.nativeElement, 'keyup');
        var merged$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(fromClick$, fromKeyUp$);
        return merged$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(1000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (value) { return value.target.value; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (value) {
            var isValidValue = !!value && !!value.trim();
            _this.handleEmptyValue(!value);
            return isValidValue;
        }));
    };
    SearchService.prototype.handleEmptyValue = function (isEmpty) {
...
var MediaQueryHelper = /** @class */ (function () {
    function MediaQueryHelper(media) {
        this.media = media;
    }
    MediaQueryHelper.prototype.getMobileQuery = function (changeDetectorRef) {
        this.mobileQuery = this.media.matchMedia('(max-width: 600px)');
        this.mobileQueryListener = function () { return changeDetectorRef.detectChanges(); };
        this.mobileQuery.addEventListener('change', this.mobileQueryListener);
        return this.mobileQuery;
    };
    MediaQueryHelper.prototype.removeMobileQueryEventListener = function () {
        this.mobileQuery.removeEventListener('change', this.mobileQueryListener);
    };
    MediaQueryHelper.ctorParameters = function () { return [
